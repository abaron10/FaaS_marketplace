...
Esta función requiere de un body para enviar por medio de un POST, para aclarar, se debe contar con un pago creado previamente (tener el payment_id) con el fin de adjuntar este valor en el campo extra1 del payload mostrado a continuación:
